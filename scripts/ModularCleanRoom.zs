...
val cleanroom97_SK = RecipeBuilder.newBuilder("cleanroom97_SK","processor_clean_room",10);
cleanroom97_SK.addEnergyPerTickInput(40000);
cleanroom97_SK.addItemInput(<contenttweaker:ascended_sky_stone>*1);
cleanroom97_SK.addItemInput(<minecraft:diamond>*64);
cleanroom97_SK.addItemInput(<ore:dustEnderPearl>*64);
cleanroom97_SK.addItemOutput(<threng:material:5>*64);
cleanroom97_SK.build();
