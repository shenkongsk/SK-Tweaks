...
<modularmachineryaddons:blockmeessentiaoutputbus>.addTooltip(format.gold("使用此仓室时，请不要应用多方块升级"));
<modularmachineryaddons:blockmeessentiaoutputbus>.addTooltip(format.gold("否则会导致亏输入"));
